  ...
  return (
    <>
      <style jsx global>{`
        ...
        .particle-3 { bottom: 20%; left: 20%; animation-delay: -4s; }
        .particle-4 { bottom: 30%; right: 10%; animation-delay: -6s; }
            ...
            <Card className="intergalactic-card text-center p-5 text-white border-0">
              ...
              <Card.Body className="position-relative" style={{ zIndex: 2 }}>
                ...
                <p className="subtitle-alien mb-4">
                  Nuestros ingenieros alienígenas están calibrando los sistemas de transmisión holográfica. 
                  <br />
                  <strong>¡Pronto podrás crear presentaciones que hipnoticen a cualquier audiencia terrestre!</strong>
                </p>
                
                <div className="mb-4">
                  <small className="text-white-50">
                    🔧 Tecnología en desarrollo • Efectos cinematográficos • IA intergaláctica
                  </small>
                </div>
